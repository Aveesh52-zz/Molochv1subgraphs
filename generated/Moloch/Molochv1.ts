...
export class Molochv1__membersResult {
  value0: Address;
  value1: BigInt;
  value2: boolean;
  value3: BigInt;
...
export class Molochv1__proposalQueueResult {
  value0: Address;
  value1: Address;
  value2: BigInt;
  value3: BigInt;
...
export class Molochv1 extends ethereum.SmartContract {
  static bind(address: Address): Molochv1 {
    return new Molochv1("Molochv1", address);
  }
  ...
  members(param0: Address): Molochv1__membersResult {
    let result = super.call(
      "members",
    ...
    return new Molochv1__membersResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBoolean(),
      result[3].toBigInt()
  ...
  try_members(param0: Address): ethereum.CallResult<Molochv1__membersResult> {
    let result = super.tryCall(
      "members",
      "members(address):(address,uint256,bool,uint256)",
      [ethereum.Value.fromAddress(param0)]
  ...
  proposalQueue(param0: BigInt): Molochv1__proposalQueueResult {
    let result = super.call(
      "proposalQueue",
    ...
    return new Molochv1__proposalQueueResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_proposalQueue(
    param0: BigInt
  ): ethereum.CallResult<Molochv1__proposalQueueResult> {
    let result = super.tryCall(
      "proposalQueue",
      "proposalQueue(uint256):(address,address,uint256,uint256,uint256,uint256,bool,bool,bool,uint256,string,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Molochv1__proposalQueueResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toBigInt(),
